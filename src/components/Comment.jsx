...
const Comment = ({ id }) => {
	...
	const [commentsLoading, setCommentsLoading] = useState(true); // State untuk loading komentar
	const [showComments, setShowComments] = useState(3);
	const [comments, setComments] = useState([]);

	const fetchComments = useCallback(async () => {
    setCommentsLoading(true); // Memulai loading
    try {
      ...
      setCommentsLoading(false); // Mengakhiri loading
    }
  }, [id]); // Dependency array hanya pada id
