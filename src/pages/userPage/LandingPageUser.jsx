import { FaAppleAlt, FaHeart } from "react-icons/fa";
import { Link } from "react-router-dom";

function LandingPageUser() {
  return (
    <div>
      <section className="bg-white text-gray-900 font-poppins">
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
            ...
            >
              ...
              <h2 className="mt-4 text-xl font-bold text-gray">Daftar Resep</h2>
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray">Resep yang anda sukai</p>
              <span className="mb-5 text-sm text-gray-500">
                Lihat lebih lanjut
              </span>
            </Link>
